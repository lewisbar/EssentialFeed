...
//  EssentialAppTests
//
//  Created by LennartWisbar on 06.11.23.
//
...
final class FeedAcceptanceTests: XCTestCase {
    ...
    private func makeData(for url: URL) -> Data {
        ...
        case "/essential-feed/v1/feed" where url.query?.contains("after_id=E0B3268A-09F4-4140-8622-6553DDDF4D75") == true:
    ...
    private func makeSecondFeedPageData() -> Data {
        return try! JSONSerialization.data(withJSONObject: ["items": [
            ["id": "E0B3268A-09F4-4140-8622-6553DDDF4D75", "image": "http://feed.com/image-2"]
        ]])
    }
